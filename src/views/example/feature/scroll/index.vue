...
<template>
	<div>
		<page-header title="记录滚动位置">
			<template #content>
				<p>当前路由需开启页面缓存。你可以滚动当前页，然后跳转到其它页面，再回来时会自动定位到离开时的滚动位置</p>
			</template>
		</page-header>

		<page-main title="宇宙起源">
			<p>
				宇宙是广袤空间和其中存在的各种天体以及弥漫物质的总称。宇宙起源是一个极其复杂的问题。
				宇宙是物质世界，它处于不断的运动和发展中。千百年来，科学家们一直在探寻宇宙是什么时候、如何形成的。直到今天，许多科学家认为，宇宙是由大约137亿年前发生的一次大爆炸形成的。宇宙内的所存物质和能量都聚集到了一起，并浓缩成很小的体积，温度极高，密度极大，瞬间产生巨大压力，之后发生了大爆炸，这次大爆炸的反应原理被物理学家们称为量子物理。大爆炸使物质四散出去，宇宙空间不断膨胀，温度也相应下降，后来相继出现在宇宙中的所有星系、恒星、行星乃至生命
			</p>
		</page-main>

		<page-main title="研究经历">
			<p class="mb-4">
...
<script setup name="FeatureScroll">
const scrollTop = ref(0) // 滚动位置

// 被包含在 <keep-alive> 中的组件，被激活时执行
onActivated(() => {
	nextTick(() => {
